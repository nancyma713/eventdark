...
event1 = Event.create!({owner_id: user1.id, category: 'Entertainment', title: 'The Magicians', description: 'Nothing around us is as it seems...and neither is the magic you think you know.', start_date: '2021/12/02 11:11:11', end_date: '2021/12/03 01:11:11'})
...
event6 = Event.create!({owner_id: user4.id, category: 'Nightlife', title: 'New Year New You', description: 'The BIGGEST party in New York, complete with open bar and music all night!', start_date: '2021/12/31 22:00:00', end_date: '2022/01/01 04:00:00'})
event7 = Event.create!({owner_id: user4.id, category: 'Free', title: 'Zoom Movie Night: Harry Potter Marathon', description: 'Social distancing movie nights streamed every week!', start_date: '2020/04/20 19:00:00', end_date: '2020/04/20 22:00:00'})
